...
\begin{figure}[!hbt]
	...
	\begin{center}
		...
		% Create a subtitle for the figure.
		\caption{Diagrama de blocos completo do DSOGI-FLL. (a) Bloco utilizado em aplicações monofásicas. (b) Bloco utilizado em aplicações trifásicas. Fonte: \cite{Meral2018}.}
		% Define the label of the figure. It's good to use 'fig:title', so you know that the label belongs to a figure.
		\label{fig:DSOGI_FLL}
	\end{center}
\end{figure}
